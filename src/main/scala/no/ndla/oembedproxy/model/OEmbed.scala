...
case class OEmbed(
    ...
    @(ApiModelProperty @field)(description =
      "The oEmbed version number. This must be 1.0.") version: String,
    @(ApiModelProperty @field)(description =
      "A text title, describing the resource.") title: Option[String],
    @(ApiModelProperty @field)(description =
      "A text description, describing the resource. Not standard.") description: Option[
      String],
    @(ApiModelProperty @field)(description =
      "The name of the author/owner of the resource.") authorName: Option[
      String],
    @(ApiModelProperty @field)(description =
      "A URL for the author/owner of the resource.") authorUrl: Option[String],
    @(ApiModelProperty @field)(description =
      "The name of the resource provider.") providerName: Option[String],
    @(ApiModelProperty @field)(
      description = "The url of the resource provider.") providerUrl: Option[
      String],
    @(ApiModelProperty @field)(description =
    ...
    @(ApiModelProperty @field)(description =
      ...
      String],
    @(ApiModelProperty @field)(description =
      "The width in pixels. Required if type is photo/video/rich") width: Option[
      Long],
    @(ApiModelProperty @field)(description =
      "The height in pixels. Required if type is photo/video/rich") height: Option[
      Long],
    @(ApiModelProperty @field)(description =
